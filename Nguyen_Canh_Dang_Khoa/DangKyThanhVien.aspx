<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DangKyThanhVien.aspx.cs" Inherits="Nguyen_Canh_Dang_Khoa.DangKyThanhVien" %>
            ...
            <table cellpadding="5" cellspacing="0" class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style7">
                        ...
                        <asp:RegularExpressionValidator ID="revTenDN" runat="server" ControlToValidate="txtTenDN" ErrorMessage="Tên đăng nhập không hợp lệ" ForeColor="#FF3300" Display="Dynamic" ValidationExpression="^[\w&_!]{8,16}$">(*)</asp:RegularExpressionValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style5">
                        ...
                        <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="txtEmail" ErrorMessage="Email không hợp lệ" ValidationExpression="Internet Email" ForeColor="#FF3300">(*)</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
